    ...
    static func getInfo() -> [GameDescription] {
        [
            GameDescription(
                ...
                rule: """
                В данной игре тебе предстоит угадать слово, которое мы
                    загадали.
                
                У тебя будет 7 жизней. Жми на букву, и, если она есть в загаданном слова, она откроется, если нет - потеряешь
                    одну жизнь.
                
                Если вдруг слова стали слишком сложными, попробуй понизить сложность.
            ...
            GameDescription(
                ...
                Как только твои жизни закончатся, ты увидишь свой результат и количество ошибок.
